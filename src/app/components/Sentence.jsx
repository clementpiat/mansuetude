...
export default function Sentence(props) {
    return (
        props.element ?
        <div className="overflow-y-auto w-[75vw] h-[35vh] sm:pt-[5vh] my-[2vh] pt-[3vh] sm:w-[65vw] font-semibold tracking-tight text-lg sm:text-2xl lg:text-3xl text-slate-200">
          {
