...
export default function Definition(props) {
    ...
    return (
        ...
        ?
        <div className={"mb-[1vh] p-[1.5vh] w-[80vw] sm:w-[35vw] h-[25vh] rounded-xl text-slate-100 " + (props.modal ? "first-bg" : "second-bg float-right")}>
            <div className="p-[1vh] sm:p-[2vh]">
                ...
                </h1>
                {
                    ...
                    <>
                        <div className="overflow-y-auto h-[12.5vh]">
                        ...
                        <div className="flex items-center justify-center pt-[1vh]">
                            {props.selectedWord.definitions.map((_, index)=>
                                <svg 
                                    ...
                                    viewBox="0 0 24 24" className={"w-[1em] h-[1em] " + (index == definitionIndex ? "" : "cursor-pointer")}
